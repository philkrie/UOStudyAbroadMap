...
function init() {
    ...
    sea_texture = THREE.ImageUtils.loadTexture('textures/sea.jpg', THREE.UVMapping, function () {
        ...
        for (var name in country_data) {
            ...
            // mat1 = new THREE.MeshLambertMaterial({ color: color })
            // mat2 = new THREE.MeshBasicMaterial( { color: 0x000000, wireframe: true, wireframe_linewidth: 10 } );
            // var mesh = country_data[name].mesh = THREE.SceneUtils.createMultiMaterialObject(geometry, [mat1]);
            ...
            // outlineMesh2.scale.set(1.1,1.1,1.1);
            
            // mesh.name = "land";
            // mesh.userData.country = name;
            // base_globe.add(mesh);
            // base_globe.add( outlineMesh2 );
        }
    });
